...
async def set_stream_link(client, message):
    try:
        ...
        if link:
            ...
            await message.reply("Usage: /stream https://t.me/ftmmovieskiduniya or http://t.me/ftmmovieskiduniya")
    except IndexError:
        await message.reply("Usage: /stream https://t.me/ftmmovieskiduniya or http://t.me/ftmmovieskiduniya")
        return
...
async def m_grp(client, message):
    links = []
    link = await client.ask(message.chat.id ,"send me your pm search grp link or send /skiplink to skip , default is ftmmovieskiduniya")
    if link.text == "/skiplink":
        links.append("https://t.me/ftmmovieskiduniya")
    else:
